(() => {
  ...
  function renderProjectInspector(id){
    ...
    const demands=(state.demands||[]).filter((d)=>d.owner_kind===(p.target_kind==='location_founding_deployment'?'founding':'project')&&d.owner_id===p.id);
