(() => {
  ...
  function renderRouteInspector(){
    ...
    const endpointText=(endpoint)=>endpoint?`${locationName(endpoint.location_id)} · ${endpoint.locator_kind}:${endpoint.locator_id}${endpoint.surface_cell_id?` · cell ${endpoint.surface_cell_id}`:''}`:'—';
