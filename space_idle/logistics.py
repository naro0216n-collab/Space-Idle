...
class LogisticsService(SupplyPlanningMixin, LogisticsFlowMixin):
    ...
    routing_constraints: dict[SupplyRoutingConstraintScope, SupplyRoutingConstraintState] = field(default_factory=dict)
    _supply_owner_resolvers: dict[str, Callable[[EntityId], bool]] = field(default_factory=dict, repr=False)
