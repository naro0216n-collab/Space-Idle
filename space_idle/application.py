...
from .application_commands import (
    ...
    PauseBuild, PauseFacility, PauseLogisticsLane, PauseResearch, PauseSurvey,
    PlanBuild, PlanFacilityUpgrade, ProduceVehicle, RefuelVehicle, ResumeBuild,
    ResumeFacility, ResumeLogisticsLane, ResumeResearch, ResumeSurvey,
    SetConstructionWeight, SetFacilityProcess, SetPowerPriority,
