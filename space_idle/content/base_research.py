...
def build_research_definitions() -> dict:
    ...
    return {
        ids.TECH_ORBITAL_OPERATIONS: ResearchDefinition(
            ...
            "自律ランデブー・標準ドッキング運用",
            120.0,
            prototype_site_requirements=lab,
        ...
        ids.TECH_MICROGRAVITY_EXPERIMENT_SYSTEMS: ResearchDefinition(
            ...
            prototype_site_requirements=lab,
            prototype_resources={ids.MACHINERY: 0.8, ids.PRECISION_ELECTRONICS: 0.8},
        ),
        ...
        ids.TECH_CREWED_ORBITAL_RESEARCH: ResearchDefinition(
            ...
            prototype_site_requirements=lab,
            prototype_resources={ids.MACHINERY: 1.5, ids.PRECISION_ELECTRONICS: 1.0},
            demonstration_days=8,
            demonstration_site_requirements=orbital_lab,
        ),
        ...
        ids.TECH_ROBOTIC_FIELD_GEOLOGY: ResearchDefinition(
            ...
            prototype_site_requirements=lab,
            prototype_resources={ids.MACHINERY: 1.5, ids.PRECISION_ELECTRONICS: 1.2},
            demonstration_days=8,
        ...
        ids.TECH_SAMPLE_ANALYSIS_SYSTEMS: ResearchDefinition(
            ...
            prototype_site_requirements=surface_lab,
            prototype_resources={ids.MACHINERY: 2.5, ids.PRECISION_ELECTRONICS: 2.0},
        ),
        ...
        ids.TECH_VACUUM_REGOLITH_PROCESS_RESEARCH: ResearchDefinition(
            ...
            prototype_site_requirements=surface_lab,
            prototype_resources={ids.MACHINERY: 3.0, ids.PRECISION_ELECTRONICS: 2.0},
            demonstration_days=12,
            demonstration_site_requirements=SiteRequirements(
                req.VACUUM_SURFACE_ENV,
                req._available_requirements("regolith_excavation"),
            ),
        ),
        ids.TECH_HIGH_TEMPERATURE_METALLURGY: ResearchDefinition(
            ...
            prototype_site_requirements=surface_lab,
            prototype_resources={ids.MACHINERY: 2.5, ids.PRECISION_ELECTRONICS: 0.9},
            demonstration_days=12,
            demonstration_site_requirements=SiteRequirements(
                req.SURFACE_ENV,
        ...
        ids.TECH_STRUCTURAL_FABRICATION: ResearchDefinition(
            ...
            prototype_site_requirements=surface_lab,
            prototype_resources={ids.MACHINERY: 2.0, ids.PRECISION_ELECTRONICS: 0.7},
            demonstration_days=8,
            demonstration_site_requirements=SiteRequirements(
                req.SURFACE_ENV,
        ...
        ids.TECH_PRECISION_MACHINING: ResearchDefinition(
            ...
            frozenset({ids.TECH_HIGH_TEMPERATURE_METALLURGY}),
            prototype_site_requirements=surface_lab,
            prototype_resources={ids.MACHINERY: 2.5, ids.PRECISION_ELECTRONICS: 1.0},
            demonstration_days=8,
            demonstration_site_requirements=SiteRequirements(
                req.SURFACE_ENV,
                req._available_requirements("metallurgy"),
        ...
        ids.TECH_HEAVY_EQUIPMENT_ASSEMBLY: ResearchDefinition(
            ...
            prototype_site_requirements=surface_lab,
            prototype_resources={ids.MACHINERY: 3.0, ids.PRECISION_ELECTRONICS: 1.2},
            demonstration_days=12,
            demonstration_site_requirements=SiteRequirements(
                req.SURFACE_ENV,
