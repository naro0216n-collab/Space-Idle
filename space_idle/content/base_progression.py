...
def build_research_definitions() -> dict:
    ...
    return {
        ...
        ids.TECH_VOLATILE_ISRU: ResearchDefinition(
            ...
            demonstration_site_requirements=SiteRequirements(
                req.COLD_VOLATILE_SURFACE_ENV,
                req._available_requirements("surface_survey"),
            ),
        ),
        ids.TECH_REGOLITH_EXCAVATION: ResearchDefinition(
            ids.TECH_REGOLITH_EXCAVATION, "レゴリス掘削・粒度制御", 110.0,
            frozenset({ids.TECH_LUNAR_PROSPECTING}),
            prototype_site_requirements=lab_prototype,
            prototype_resources={ids.MACHINERY: 1.5, ids.PRECISION_ELECTRONICS: 0.5},
            demonstration_days=10,
            demonstration_site_requirements=SiteRequirements(
                req.SURFACE_ENV,
                req._available_requirements("surface_survey"),
            ),
        ...
        ids.TECH_LUNAR_MATERIALS: ResearchDefinition(
            ids.TECH_LUNAR_MATERIALS, "真空レゴリス焼結", 120.0,
            frozenset({ids.TECH_REGOLITH_EXCAVATION}),
            prototype_site_requirements=lab_prototype,
            prototype_resources={ids.MACHINERY: 2.0, ids.PRECISION_ELECTRONICS: 0.4},
            demonstration_days=10,
            demonstration_site_requirements=SiteRequirements(
                req.SURFACE_ENV,
                req._available_requirements("regolith_excavation"),
            ),
        ),
        ids.TECH_ORE_BENEFICIATION: ResearchDefinition(
            ids.TECH_ORE_BENEFICIATION, "真空粒度選別・鉱物濃縮", 130.0,
            frozenset({ids.TECH_REGOLITH_EXCAVATION}),
            prototype_site_requirements=lab_prototype,
            prototype_resources={ids.MACHINERY: 2.0, ids.PRECISION_ELECTRONICS: 0.6},
            demonstration_days=10,
            demonstration_site_requirements=SiteRequirements(
                req.SURFACE_ENV,
                req._available_requirements("regolith_excavation"),
        ...
        ids.TECH_HIGH_TEMPERATURE_METALLURGY: ResearchDefinition(
            ids.TECH_HIGH_TEMPERATURE_METALLURGY, "高温酸化物還元・金属分離", 160.0,
            frozenset({ids.TECH_ORE_BENEFICIATION}),
            prototype_site_requirements=lab_prototype,
            prototype_resources={ids.MACHINERY: 2.5, ids.PRECISION_ELECTRONICS: 0.7},
            demonstration_days=12,
            demonstration_site_requirements=SiteRequirements(
                req.SURFACE_ENV,
                req._available_requirements("ore_processing"),
            ),
        ),
        ids.TECH_STRUCTURAL_FABRICATION: ResearchDefinition(
            ids.TECH_STRUCTURAL_FABRICATION, "真空成形・構造材接合", 130.0,
            frozenset({ids.TECH_HIGH_TEMPERATURE_METALLURGY}),
            prototype_site_requirements=lab_prototype,
            prototype_resources={ids.MACHINERY: 2.0, ids.PRECISION_ELECTRONICS: 0.5},
            demonstration_days=8,
            demonstration_site_requirements=SiteRequirements(
                req.SURFACE_ENV,
                req._available_requirements("metallurgy"),
            ),
        ),
        ids.TECH_PRECISION_MACHINING: ResearchDefinition(
            ids.TECH_PRECISION_MACHINING, "低重力精密機械加工", 150.0,
            frozenset({ids.TECH_HIGH_TEMPERATURE_METALLURGY}),
            prototype_site_requirements=lab_prototype,
            prototype_resources={ids.MACHINERY: 2.5, ids.PRECISION_ELECTRONICS: 0.8},
            demonstration_days=8,
            demonstration_site_requirements=SiteRequirements(
                req.SURFACE_ENV,
                req._available_requirements("metallurgy"),
        ...
        ids.TECH_HEAVY_EQUIPMENT_ASSEMBLY: ResearchDefinition(
            ids.TECH_HEAVY_EQUIPMENT_ASSEMBLY, "モジュール重機組立・整備", 180.0,
            frozenset({ids.TECH_STRUCTURAL_FABRICATION, ids.TECH_PRECISION_MACHINING}),
            prototype_site_requirements=lab_prototype,
            prototype_resources={ids.MACHINERY: 3.0, ids.PRECISION_ELECTRONICS: 1.0},
            demonstration_days=12,
            demonstration_site_requirements=SiteRequirements(
                req.SURFACE_ENV,
        ...
        ids.TECH_INDUSTRIAL_ELECTROLYSIS: ResearchDefinition(
            ids.TECH_INDUSTRIAL_ELECTROLYSIS, "高圧水電解・酸素水素分離", 140.0,
            ...
            demonstration_site_requirements=SiteRequirements(
                req.SURFACE_ENV,
                req._available_requirements("water_extraction"),
            ),
        ),
        ids.TECH_PROPELLANT_HANDLING: ResearchDefinition(
            ids.TECH_PROPELLANT_HANDLING, "酸素・水素液化・極低温推進剤調製", 170.0,
