...
def build_facility_definitions() -> dict:
    ...
    definitions = {
        ...
        ids.VOLATILE_EXTRACTOR: FacilityDef(ids.VOLATILE_EXTRACTOR, "揮発性原料採取設備", req._capabilities("volatile_extraction"), surface, req.COLD_VOLATILE_SURFACE_SITE),
        ...
        ids.VACUUM_MINERAL_HARVESTER: FacilityDef(ids.VACUUM_MINERAL_HARVESTER, "真空粒状鉱物採掘設備", req._capabilities("granular_mineral_extraction"), surface, req.VACUUM_SURFACE_SITE),
