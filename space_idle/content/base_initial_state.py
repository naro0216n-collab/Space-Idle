...
def configure_initial_inventory(inventory) -> None:
    for resource in (ids.STRUCTURAL_COMPONENTS, ids.MACHINERY, ids.PRECISION_ELECTRONICS, ids.CONSTRUCTION_EQUIPMENT, ids.CONTRACT_PAYLOAD):
    ...
    inventory.add(ids.EARTH, ids.STRUCTURAL_COMPONENTS, 10000.0)
    inventory.add(ids.EARTH, ids.MACHINERY, 10000.0)
    inventory.add(ids.EARTH, ids.PRECISION_ELECTRONICS, 10000.0)
    inventory.add(ids.EARTH, ids.CONSTRUCTION_EQUIPMENT, 1000.0)
    inventory.add(ids.EARTH, ids.CONTRACT_PAYLOAD, 1000.0)
