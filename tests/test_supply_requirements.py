...
def _requirement(requirement_id: str, amount_t: float, priority: int) -> SupplyRequirement:
...
def test_local_supply_netting_respects_priority_order_and_durable_reservations():
    ...
    first = _requirement("requirement.a", 3.0, 3)
